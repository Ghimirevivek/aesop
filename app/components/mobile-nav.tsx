      ...
      <div className='flex items-center justify-end px-4 py-4'>
        <Link href='/' className={`z-40 mr-auto`}>
          <svg
            ...
            width='70'
            style={{ height: '22px', width: '70px', filter: 'invert(1)' }}
          >
            <title aria-label='Aesop' id='aesop-:r6g:'>
              Aesop
            </title>
            <g>
...
//         </Button>
//       </SheetTrigger>
//       <SheetContent side='left' className='w-[300px] bg-[#FFFEF2]'>
